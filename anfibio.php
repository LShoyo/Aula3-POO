    ...
    <section class="row py-5">
        <article class="col-12 col-lg-10 mx-auto bg-light rounded p-3">
            ...
            <div class="col-12">
                <table class="table text-center">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th scope="col"><i class="fas fa-<?= $anfibio->icon ?>"></i><br />Anfibio<br /><small>Filha da classe CLASSE AnimalVertebrado</small></th>
                    ...
                    <tbody>
                        ...
                        <tr class="bg-warning font-weight-bold">
                            ...
                            <td>Propriedade <b>privada declarada e definida na própria classe Anfibio</b></td>
                        </tr>
                        <tr>
                            <td>Respiração</td>
                ...
                <a href="./anfibio-sapo.php" class="btn btn-dark d-block w-25 ml-auto mt-4 mb-3">Conheça o Anfibio Sapo</a>
            </div>
        </article>
    </section>
</main>
